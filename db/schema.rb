...
ActiveRecord::Schema.define(version: 2020_03_10_065948) do
  ...
  create_table "audios", force: :cascade do |t|
    ...
    t.index ["track_id"], name: "index_audios_on_track_id"
  end
  ...
  create_table "track_donations", force: :cascade do |t|
    t.integer "track_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
